<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex flex-col lg:flex-row max-h-[calc(100vh-85px)]">
      <!-- Sidebar - Chapter List -->
      <aside
        class="fixed inset-y-0 left-0 z-40 w-full sm:w-64 lg:w-80 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-300 lg:static lg:translate-x-0"
      ...
      >
        <div class="flex flex-col h-full p-4">
          ...
          <div class="space-y-2 overflow-y-auto h-[calc(100vh-120px)]">
            <div
      ...
      <!-- Main Content Area -->
      <div class="flex-1 flex flex-col lg:flex-row max-w-full mx-auto">
        <!-- Content Panel -->
        ...
        <div
          class="fixed inset-x-0 bottom-0 lg:static lg:w-96 bg-white dark:bg-gray-900 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-800 flex flex-col z-30"
          :class="toolsOpen ? 'translate-y-0' : 'translate-y-full lg:translate-y-0'"
        >
          <!-- Tools Header -->
          ...
          <!-- Tools Content -->
          <div class="flex-1">
            <UTabs :items="toolTabs" class="items:overflow-y-auto w-full">
              <!-- Issues Tab -->
              <template #issues>
