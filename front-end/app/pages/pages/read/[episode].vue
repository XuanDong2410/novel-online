...
import type {
  ...
  ThemeBase,
  Volume
} from "src/components/ln-reader/index.vue"
import { SwiperPluginFade } from "src/plugins/swiper-plugin-fade"
import { SwiperPluginFlip } from "src/plugins/swiper-plugin-flip"
...
const $fontFamily = ref<Font["value"]>("Nunito")
