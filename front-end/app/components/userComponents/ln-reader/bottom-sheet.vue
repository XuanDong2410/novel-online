<template>
  <Teleport to="body">
    ...
    >
      ...
      <div ref="bottomSheetContent" :class="sheetContentClasses" v-bind="attrs">
 ...
 * Sheet height value
 */
const sheetHeight = ref(props.minHeight)
...
const bottomSheetHeader = ref<HTMLElement>()
const bottomSheetMain = ref<HTMLElement>()
const bottomSheetFooter = ref<HTMLElement>()
const bottomSheetContent = ref<HTMLElement>()
const bottomSheetDraggableArea = ref<HTMLElement>()
 ...
 */
defineExpose({ open, close, showSheet })
</script>
...
.bottom-sheet {
  ...
  * {
  ...
  &__draggable-thumb {
    width: 40px;
    height: 4px;
    background: currentColor; // #333333;
    border-radius: 8px;
    margin: 0 auto;
  }
