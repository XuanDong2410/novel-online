...
export const chapters: Chapter[] = [
  // Truyện 1: Ta là tà đế
  {
    id: 1,
    novelId: 1,
    index: 1,
    title: 'Chương 1: Thức tỉnh tại Ma vực',
    content: `- Ưm, ta đang ở nơi nào thế này?
...
`,
    createAt: '2020-03-25T13:25:00'
  },
  {
    id: 2,
    novelId: 1,
    index: 2,
    title: 'Chương 2: Đối đầu thiếu chủ Ma tông',
    content: 'Thiếu chủ Ma tông xuất hiện, khiêu khích và muốn giết hắn, nhưng hắn lại lộ ra sát khí kinh người...',
    createAt: '2020-03-26T10:00:00'
  },
  {
    id: 3,
    novelId: 1,
    index: 3,
    title: 'Chương 3: Hệ thống tà đế kích hoạt',
    content: 'Một giọng nói vang lên trong đầu: "Kích hoạt hệ thống tà đế... nhiệm vụ đầu tiên bắt đầu!"',
    createAt: '2020-03-27T08:30:00'
  },

  // Truyện 2: Hệ thống phản phái
  {
    id: 4,
    novelId: 2,
    index: 1,
    title: 'Chương 1: Phản bội',
    content: 'Bị huynh đệ thân thiết đâm sau lưng, hắn chết một cách thê thảm... nhưng đó chưa phải là kết thúc.',
    createAt: '2020-02-21T14:00:00'
  },
  {
    id: 5,
    novelId: 2,
    index: 2,
    title: 'Chương 2: Hệ thống phản phái đến',
    content: 'Một bảng điều khiển kỳ lạ xuất hiện: "Phát hiện phản bội, khởi động hệ thống phản phái!"',
    createAt: '2020-02-22T09:15:00'
  },
  {
    id: 6,
    novelId: 2,
    index: 3,
    title: 'Chương 3: Kẻ mạnh trả thù',
    content: 'Hắn trở lại từ cõi chết, mang theo sức mạnh hệ thống, thề sẽ hủy diệt kẻ từng phản bội.',
    createAt: '2020-02-23T11:00:00'
  },
  ...
  // Truyện 3: Già thiên
  {
    ...
    novelId: 3,
    index: 1,
    title: 'Chương 1: Huyền bí cỗ quan tài',
    content: 'Một nhóm sinh viên phát hiện một cỗ quan tài kỳ lạ trên núi, mở ra cánh cửa dẫn đến vũ trụ rộng lớn...',
    createAt: '2020-01-15T10:00:00'
  },
  {
    id: 8,
    novelId: 3,
    index: 2,
    title: 'Chương 2: Truyền thuyết cổ xưa',
    content: 'Câu chuyện về Thánh thể và những di tích cổ xưa bắt đầu được hé lộ...',
    createAt: '2020-01-16T13:20:00'
  },
  {
    id: 9,
    novelId: 3,
    index: 3,
    title: 'Chương 3: Tế đàn và bí mật',
    content: 'Tế đàn cổ hiện lên giữa tinh không, dẫn lối cho một cuộc hành trình bất tận...',
    createAt: '2020-01-17T09:45:00'
  }
]
